...
class GainSkillCurrentCommand (ProxyPlugin.CommandParser):
    def parse(self, cmdEvent):
        ...
        ClassAbilityClient.skillAlterCurrent(playerOid, skillType, skillBoost)
        return None
...
class GMCommand (ProxyPlugin.CommandParser):
    def parse(self, cmdEvent):
        ...
        if gmState == 0:
            ...
            WorldManagerClient.sendObjChatMsg(playerOid, 0, "GM Mode deactivated, you can now be attacked")
        else:
            ...
            WorldManagerClient.sendObjChatMsg(playerOid, 0, "GM Mode activated, you can no longer be attacked")
        return None
